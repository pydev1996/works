...
# %%
# car=pd.read_csv('OLX_Car_Data_CSV.csv', encoding='latin1')
#
# # %%
# car.head()
#
...
# %%
# car.to_csv('New_Cleaned_Car_data.csv')
car=pd.read_csv('newPakwheeldst.csv', encoding='latin1')

car['company']=car['company'].astype(str)
...
X=car[['model','company','year','kms_driven','fuel_type']]
y=car['Price']
